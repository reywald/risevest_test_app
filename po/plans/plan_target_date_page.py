...
class PlanTargetDatePage(PlanBasePage):
    ...
    def __init__(self, browser, tester: TestCase, plan_data: dict):
        ...
        self.QUESTION_3 = (By.XPATH, "//p[contains(text(), 'Question')]")
    ...
    def validate_page(self):
        WebDriverWait(self.browser, 20).until(
            EC.url_contains("stage=targetDate"))
        ...
        self.tester.assertEqual(self.get_element(self.QUESTION_3).text,
                                "Question 3 of 3",
                                "Question text is not matched.")

        self.tester.assertEqual(self.get_element(self.INPUT_TEXT).text,
